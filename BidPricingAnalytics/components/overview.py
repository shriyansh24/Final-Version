...
def show_overview(won_data: pd.DataFrame, lost_data: pd.DataFrame, combined_data: pd.DataFrame) -> None:
    ...
    try:
        ...
        with col1:
            ...
            st.plotly_chart(fig, use_container_width=True, key='overview_type_distribution')
        
        with col2:
            # Create and display CPI boxplot
            fig = create_cpi_distribution_boxplot(won_data, lost_data)
            st.plotly_chart(fig, use_container_width=True, key='overview_cpi_boxplot')
        ...
        st.plotly_chart(fig, use_container_width=True, key='overview_cpi_vs_ir')
        ...
        st.plotly_chart(fig, use_container_width=True, key='overview_cpi_efficiency')
        ...
        if date_col is not None:
            ...
            try:
                ...
                if not recent_won.empty:
                    ...
                    st.plotly_chart(fig, use_container_width=True, key='overview_monthly_volume')
                else:
